...
<article class="cl pd-20" id="app">
	...
	<form class="form form-horizontal" id="form-admin-add" action="{{route('admin.fangattr.store')}}" method="post">
		@csrf
...
<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="hidden" class="input-text"  id="icon" name="icon" >
				<div id="picker">选择文件</div>
				<img id="pic" width="40" height="40">
			</div>
		</div>
	...
	<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="adminName" name="field_name" >
